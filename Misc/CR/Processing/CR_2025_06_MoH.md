...
## ∘───── 🛠️ RAM Digging & Code Notes ─────∘
Seems like you've done a thorough job scanning through all the necessary RAM for creating the set, all seems documented well. You also code noted some extra logic, which may or may not be useful for other projects, but alas this shows you were very thorough with RAM digging. Trying to RAM dig parts of a game which may not always be useful for achievement development still is a great learning experience and sometimes these lead to more useful stuff.
...
## ∘───── ✍️ Titles & Descriptions ─────∘
If any of below remarks prove difficult, you could consider [#writing-requests on RAdiscord](https://discord.com/channels/310192285306454017/1100757231294750730)
...
### 👍 Positive Observations
- Rich Presence looks great! (A few suggestions, see below)
...
For your defaults display string you have `In the menus`, perhaps something that would be more broad could be more intersting here since you already have a conditional for being at MainMenu.
