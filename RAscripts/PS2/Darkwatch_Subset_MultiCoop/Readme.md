...
- 💎 **[Achievement Guide](#AchievementGuide)** 
    ...
    - 🏆 *[Story Ending](#c_StoryEnd)*
    - 🏆 *[Singleplayer/Gunslinger Challenges](#c_Challenge)*
...
The zero-point achievement ([a_INFOcoop](#a_INFOcoop)) is included in the set to inform players of this system and ensure everyone is aware of the co-op participation rules.
...
<h1 id=c_Story>
    🏆 Story Progression <i><sub><sup>(_COUNT_ achievements - _XX_ points)</sup></sub></i>
</h1>
