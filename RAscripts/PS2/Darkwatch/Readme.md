...
| <h3 id=a_GunBoneyard>**Waking the Reckoning**</h3><br><sub>*a_GunBoneyard*</sub> <br><br> ![Achievement badge icon](https://i.retroachievements.org/Badge/00000.png "Achievement badge icon") | Complete Chapter 3, **"Boneyard"**, in Gunslinger Mode on Deadeye difficulty, with no deaths, achieving at least 80 kills using the Carbine or Crossbow, and without throwing any explosives <br><br> <h4>Fail Conditions</h4> - Player dies <br> - Player uses a throwable explosive <br>  <br> <sub> If any fail condition is met, the player can easily retry the challenge by following the methods documented [above](#retrying-the-challenge-achievement) <br><br> <h4>Achievement Tracking</h4> - A [Trigger Indicator](#RA_Trigger) is displayed when the player has the Carbine or Crossbow equipped. It will also be displayed once 80 kills have been achieved with the required weapons. It will be removed when any fail condition is met. <br> - A [Measured Indicator](#RA_Measured) tracks kills with the Carbine or Crossbow up to 80. |
| <h3 id=a_GunDevilMine>**Six Shooters' Tirade**</h3><br><sub>*a_GunDevilMine*</sub> <br><br> ![Achievement badge icon](https://i.retroachievements.org/Badge/00000.png "Achievement badge icon") | Complete Chapter 4, **"Devil's Belly Mine"**, in Gunslinger Mode on Deadeye difficulty, with no deaths, using only the Redeemer or Dual Pistols, and without using any powers <br><br> <h4>Fail Conditions</h4> - Player dies <br> - Player earns a kill whilst not having any of the required weapons equipped. <br> - Player uses a (vampire) power <br> <sub> If any fail condition is met, the player can easily retry the challenge by following the methods documented [above](#retrying-the-challenge-achievement) <br><br> <h4>Achievement Tracking</h4> - A [Trigger Indicator](#RA_Trigger) is displayed when the player has any of the required weapons equipped. It will be removed when any fail condition is met. |
| <h3 id=a_GunDWOutpost>**The Hunger Within**</h3><br><sub>*a_GunDWOutpost*</sub> <br><br> ![Achievement badge icon](https://i.retroachievements.org/Badge/00000.png "Achievement badge icon") |  Complete Chapter 5, **"Darkwatch Outpost"**, in Gunslinger Mode on Deadeye difficulty, with no deaths, and without being below max HP for more than 20 consecutive seconds <br><br> <h4>Fail Conditions</h4> - Player dies <br> - Player is below max HP for longer than 20 consecutive seconds <br> <sub> If any fail condition is met, the player can easily retry the challenge by following the methods documented [above](#retrying-the-challenge-achievement) <br><br> <h4>Achievement Tracking</h4> - A [Trigger Indicator](#RA_Trigger) is displayed when the Chapter starts. It is removed why any fail condition is met. <br> - A [Measured Indicator](#RA_Measured) tracks consecutive seconds left below max HP until the challenge fails. Countdown resets when player is back at full hp. |
| <h3 id=a_GunWarTrain>**Unburned by the Boiler**</h3><br><sub>*a_GunWarTrain*</sub> <br><br> ![Achievement badge icon](https://i.retroachievements.org/Badge/00000.png "Achievement badge icon") | Complete Chapter 6, **"War Train"**, in Gunslinger Mode on Deadeye difficulty, within 5 minutes, no deaths, and without losing any HP <br><br> <h4>Fail Conditions</h4> - Player dies <br> - Mission time exceeds 5 minutes <br> - Player loses HP (vampire shield excluded) <br> <sub> If any fail condition is met, the player can easily retry the challenge by following the methods documented [above](#retrying-the-challenge-achievement) <br><br> <h4>Achievement Tracking</h4> - A [Trigger Indicator](#RA_Trigger) is displayed when the Chapter starts. It is removed once any fail condition is met. <br> - A [Measured Indicator](#RA_Measured) tracks seconds left till mission time hits 5 minutes (= 300 seconds). |
| <h3 id=a_GunTortureMaze>**The Butcher's Gospel**</h3><br><sub>*a_GunTortureMaze*</sub> <br><br> ![Achievement badge icon](https://i.retroachievements.org/Badge/00000.png "Achievement badge icon") | Complete Chapter 7, **"Torture Maze"**, in Gunslinger Mode on Deadeye difficulty, with no deaths, only killing with the Scepter or Shotgun, and with at least 60% melee kills <br><br> <h4>Fail Conditions</h4> - Player dies <br> - Player earns a kill with a disallowed weapon. <br>  <br> <sub> If any fail condition is met, the player can easily retry the challenge by following the methods documented [above](#retrying-the-challenge-achievement) <br><br> <h4>Achievement Tracking</h4> - A [Trigger Indicator](#RA_Trigger) is displayed once the Chapter starts. It is removed when any fail condition is met. <br> - A [Measured Indicator](#RA_Measured) tracks the ratio of melee kills to total kills in percent. The player is required to finish the Chapter with this at 60% or above in order to unlock the achievement. |
| <h3 id=a_GunBaptismFire>**Clean Shots, Dirty Work**</h3><br><sub>*a_GunBaptismFire*</sub> <br><br> ![Achievement badge icon](https://i.retroachievements.org/Badge/00000.png "Achievement badge icon") | Complete Chapter 8, **"Baptism of Fire"**, in Gunslinger Mode on Deadeye difficulty, with no deaths, using only the Redeemer or Rail Rocket, and without scoring 5 body-shot kills in a row—mix it up with headshot or melee kills <br><br> <h4>Fail Conditions</h4> - Player dies <br> - Player earns a kill using a disallowed weapon. <br> - Player uses a throwable explosive. <br> - Player scores 5 body-shot kills in a row. <br> <sub> If any fail condition is met, the player can easily retry the challenge by following the methods documented [above](#retrying-the-challenge-achievement) <br><br> <h4>Achievement Tracking</h4> - A [Trigger Indicator](#RA_Trigger) is displayed once the Chapter starts. It is removed when any fail condition is met. <br> - A [Measured Indicator](#RA_Measured) tracks consecutive body-shot kills up to 5, once this hits 5/5 the challenge fails, it resets when scoring a melee or headshot kill. |
| <h3 id=a_GunRescue>**No Blood of Mine**</h3><br><sub>*a_GunRescue*</sub> <br><br> ![Achievement badge icon](https://i.retroachievements.org/Badge/00000.png "Achievement badge icon") | Complete Chapter 9, **"Rescue"**, in Gunslinger Mode on Deadeye difficulty, with no deaths, and without losing any HP <br><br> <h4>Fail Conditions</h4> - Player dies <br> - Player loses HP (vampire shield excluded) <br> <sub> If any fail condition is met, the player can easily retry the challenge by following the methods documented [above](#retrying-the-challenge-achievement) <br><br> <h4>Achievement Tracking</h4> - A [Trigger Indicator](#RA_Trigger) is displayed once the Chapter starts. It is removed once any fail condition is met. |
| <h3 id=a_GunPrism>**Sunburst Rush**</h3><br><sub>*a_GunPrism*</sub> <br><br> ![Achievement badge icon](https://i.retroachievements.org/Badge/00000.png "Achievement badge icon") | Complete Chapter 10, **"The Deadlight Prism"**, in Gunslinger Mode on Deadeye difficulty within 15 minutes, no deaths, and killing only with the Dual Pistols or Shotgun equipped <br><br> <h4>Fail Conditions</h4> - Player dies <br> - Player earns a kill with a disallowed weapon. <br> - Mission time exceeds 15 minutes. <br> <sub> If any fail condition is met, the player can easily retry the challenge by following the methods documented [above](#retrying-the-challenge-achievement) <br><br> <h4>Achievement Tracking</h4> - A [Trigger Indicator](#RA_Trigger) is displayed when the Chapter starts. It is removed once any fail condition is met. <br> - A [Measured Indicator](#RA_Measured) tracks seconds left till mission time hits 15 minutes (= 900 seconds). |

| <h3 id=a_GunInvasion>**Disciplined Wrath**</h3><br><sub>*a_GunInvasion*</sub> <br><br> ![Achievement badge icon](https://i.retroachievements.org/Badge/00000.png "Achievement badge icon") | Complete Chapter 11, **"Invasion"**, in Gunslinger Mode on Deadeye difficulty, with no deaths, using only one distinct power, and with only 5 allowed power activations <br><br> <h4>Fail Conditions</h4> - Player dies <br> - _fail_condition_info_ <br> <sub> If any fail condition is met, the player can easily retry the challenge by following the methods documented [above](#retrying-the-challenge-achievement) <br><br> <h4>Achievement Tracking</h4> - A [Trigger Indicator](#RA_Trigger) is displayed when ... <br> - A [Measured Indicator](#RA_Measured) tracks ... up to ... <br><br> <sub> **Misc note ⁃** *_MISC_NOTE_HERE_* </sub> <br> <sub>**Developer note ⁃** *_DEVELOPER_NOTE_HERE_* </sub> |
| <h3 id=a_GunHangtown>**No Loose Lead"**</h3><br><sub>*a_GunHangtown*</sub> <br><br> ![Achievement badge icon](https://i.retroachievements.org/Badge/00000.png "Achievement badge icon") | Complete Chapter 12, **"Hangtown"**, in Gunslinger Mode on Deadeye difficulty, with no deaths, and achieving at least 75% accuracy, only shooting with the Range Rifle or Redeemer <br><br> <h4>Fail Conditions</h4> - Player dies <br> - _fail_condition_info_ <br> <sub> If any fail condition is met, the player can easily retry the challenge by following the methods documented [above](#retrying-the-challenge-achievement) <br><br> <h4>Achievement Tracking</h4> - A [Trigger Indicator](#RA_Trigger) is displayed when ... <br> - A [Measured Indicator](#RA_Measured) tracks ... up to ... <br><br> <sub> **Misc note ⁃** *_MISC_NOTE_HERE_* </sub> <br> <sub>**Developer note ⁃** *_DEVELOPER_NOTE_HERE_* </sub> |
| <h3 id=a_GunMorningAfter>**Brutal Grace**</h3><br><sub>*a_GunMorningAfter*</sub> <br><br> ![Achievement badge icon](https://i.retroachievements.org/Badge/00000.png "Achievement badge icon") | Complete Chapter 13, **"The Morning After"**, in Gunslinger Mode on Deadeye difficulty, with no deaths, using only tier 2 or 3 powers, and with at least 45% melee kills <br><br> <h4>Fail Conditions</h4> - Player dies <br> - _fail_condition_info_ <br> <sub> If any fail condition is met, the player can easily retry the challenge by following the methods documented [above](#retrying-the-challenge-achievement) <br><br> <h4>Achievement Tracking</h4> - A [Trigger Indicator](#RA_Trigger) is displayed when ... <br> - A [Measured Indicator](#RA_Measured) tracks ... up to ... <br><br> <sub> **Misc note ⁃** *_MISC_NOTE_HERE_* </sub> <br> <sub>**Developer note ⁃** *_DEVELOPER_NOTE_HERE_* </sub> |
| <h3 id=a_GunShowdown>**Bare-Fanged Brawl**</h3><br><sub>*a_GunShowdown*</sub> <br><br> ![Achievement badge icon](https://i.retroachievements.org/Badge/00000.png "Achievement badge icon") | Complete Chapter 14, **"Showdown"**, in Gunslinger Mode on Deadeye difficulty, with no deaths, using only tier 1 powers, and with at least 65% accuracy <br><br> <h4>Fail Conditions</h4> - Player dies <br> - _fail_condition_info_ <br> <sub> If any fail condition is met, the player can easily retry the challenge by following the methods documented [above](#retrying-the-challenge-achievement) <br><br> <h4>Achievement Tracking</h4> - A [Trigger Indicator](#RA_Trigger) is displayed when ... <br> - A [Measured Indicator](#RA_Measured) tracks ... up to ... <br><br> <sub> **Misc note ⁃** *_MISC_NOTE_HERE_* </sub> <br> <sub>**Developer note ⁃** *_DEVELOPER_NOTE_HERE_* </sub> |
| <h3 id=a_GunRightTrain>**Irons on the Rails**</h3><br><sub>*a_GunRightTrain*</sub> <br><br> ![Achievement badge icon](https://i.retroachievements.org/Badge/00000.png "Achievement badge icon") | Complete Chapter 15, **"The Right Train"**, in Gunslinger Mode on Deadeye difficulty within 7 minutes, no deaths, and without dropping below 70% HP <br><br> <h4>Fail Conditions</h4> - Player dies <br> - _fail_condition_info_ <br> <sub> If any fail condition is met, the player can easily retry the challenge by following the methods documented [above](#retrying-the-challenge-achievement) <br><br> <h4>Achievement Tracking</h4> - A [Trigger Indicator](#RA_Trigger) is displayed when ... <br> - A [Measured Indicator](#RA_Measured) tracks ... up to ... <br><br> <sub> **Misc note ⁃** *_MISC_NOTE_HERE_* </sub> <br> <sub>**Developer note ⁃** *_DEVELOPER_NOTE_HERE_* </sub> |
| <h3 id=a_GunDeadfall>**Deadshot Descent**</h3><br><sub>*a_GunDeadfall*</sub> <br><br> ![Achievement badge icon](https://i.retroachievements.org/Badge/00000.png "Achievement badge icon") | Complete Chapter 16, **"Deadfall"**, in Gunslinger Mode on Deadeye difficulty, with no deaths, achieving at least 30% headshot kills using only the Range Rifle or Carbine <br><br> <h4>Fail Conditions</h4> - Player dies <br> - _fail_condition_info_ <br> <sub> If any fail condition is met, the player can easily retry the challenge by following the methods documented [above](#retrying-the-challenge-achievement) <br><br> <h4>Achievement Tracking</h4> - A [Trigger Indicator](#RA_Trigger) is displayed when ... <br> - A [Measured Indicator](#RA_Measured) tracks ... up to ... <br><br> <sub> **Misc note ⁃** *_MISC_NOTE_HERE_* </sub> <br> <sub>**Developer note ⁃** *_DEVELOPER_NOTE_HERE_* </sub> |
